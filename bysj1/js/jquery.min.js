...
//自定义的函数————————————————与动物英文名联动有关
//修改parent的标题
function changeParentLable(aLable)
{
	document.getElementById("zhuti2").innerHTML=aLable;
}
	//自定义数组代表由物种到englishName的映射
var mapping_from_Goat2EnglishName =["All English Name","goat","capra hircus","caprine","male goat","capra aegagrus hircu","ovis","ram","ewe","yow"]
var mapping_from_Bos2EnglishName =["All English Name","bull","cattle","cow","yak","zebu","zebu cattle","bos grunniens","bos indicus","bos taurus","bovine","holstein","shorthorn","shorthorn zebu","simmental","red spotted simmenta","holstein friesian","niu","ox","red holstein","polish holstein frie","chianina","grunniens","domestic yak","red danish","german simmental","braunvieh","bovidae","small african zebu","milking zebu","bovids","bovinae","poephagus"]
var mapping_from_Pig2EnglishName =["All English Name","boar","suidae","peccaries","peccary","duroc","swine","porcine","pig","sus ahoenobarbus","scrofa","sus heureni","domestic pig","sus scrofa","sow","pietrain","piglet","hog","sus scrofa domesticu"]
var mapping_from_Sheep2EnglishName=["All English Name","sheep","ovine","ovis aries","finnish landrace","merino","welsh mountain","perendale","coopworth","east friesian","finnsheep","awassi","tsigai","karakul","poll dorset","ovis","ram","ewe","yow"]
var mapping_from_Horse2EnglishName =["All English Name","stallion","horse","equine","equus","mare","warmblood","pony","standardbred","colt"]
var mapping_from_Dankey2EnglishName =["All English Name","equus asinus","burro","ass","jenny","jack","asinus","hemionus","dickey"]
var mapping_from_Chicken2EnglishName =["All English Name","bantam","chicken","domestic fowl","poultry","gallus","turkey","broiler","leghorn","domestic bird","fowl","hen","breeding bird","meleagris","gallopavo","cornish","rooster","white holland","cock","australorp","junglefowl","light sussex","pheasant","silkie"]
var mapping_from_Duck2EnglishName =["All English Name","merganser","duck","anas","mallard","female duck","anas platyrhynchos","teal"]
var mapping_from_Goose2EnglishName =["All English Name","domesticus","geese","goose"]	
function searchLiandong1to2(selectedText)
{
	document.getElementById("zhuti").innerHTML=selectedText;
	//var elem = document.getElementById("dropdownMenu1");
	var tempAnimal_englishNameList=null;
	eval("var tempAnimal_englishNameList = " + "mapping_from_"+selectedText+"2EnglishName");
	//alert(tempAnimal_englishNameList);
	var add2ui = document.getElementById("dropdownMenu2UiList");
	//开始清除并创建插入的对象
	add2ui.innerHTML="";
	for (term in tempAnimal_englishNameList)
	{
		//alert(tempAnimal_englishNameList[term]);
		var newOuterElement = document.createElement("li");
		newOuterElement.setAttribute("role","presentation");
		newOuterElement.setAttribute("class","dropdownMenu2UiList_li");
		var newInnerElement = document.createElement("a");
		newInnerElement.setAttribute("role","menuitem");
		newInnerElement.tabindex="-1";
		newInnerElement.setAttribute("onclick","changeParentLable(this.innerHTML)");
		newInnerElement.innerHTML=tempAnimal_englishNameList[term];
		newOuterElement.appendChild(newInnerElement);
		
		//插入到节点
		add2ui.appendChild(newOuterElement);
	}
}
//自定义函数与物种关键词英文名有关
